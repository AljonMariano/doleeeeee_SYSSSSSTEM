    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                    Total Vouchers: {{ \App\Models\Voucher::count() }}
                </p>
            </div>
            <a href="{{ route('vouchers.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                Add New Voucher
            </a>
        </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('vouchers.index') }}" method="GET" class="space-y-4">
                            ...
                            @forelse($vouchers as $voucher)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        ...
                                        <a href="{{ route('vouchers.edit', $voucher) }}" class="text-indigo-600 hover:text-indigo-900">Edit</a>
