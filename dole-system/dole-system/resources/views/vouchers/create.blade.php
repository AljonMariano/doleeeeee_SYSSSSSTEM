                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('vouchers.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="voucher_id" id="voucher_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" value="{{ old('voucher_id') }}" required>
                            @error('voucher_id')
